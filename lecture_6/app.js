...
const fetchData = async () => {
  // using the live data via api : 
     const data = await fetch ("https://www.swiggy.com/dapi/restaurants/list/v5?lat=26.464101&lng=80.344457&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING") ; 
